...
this.after('READ', 'Products', (results) => {
    for (const p of results) {
        if(p.stock === 0){
            p.stockCriticality = 1; // Out of stock
        }else if(p.stock<10){
            p.stockCriticality = 2; // Low stock
        }else p.stockCriticality = 3; // Sufficient stock
    }
});
...
//     for (const p of results){
//         if(p.priority === 'High') {
//             p.priorityCriticality = 1;
//         } else if (p.priority === 'Medium') {
//             p.priorityCriticality = 2;
//         } else if (p.priority === 'Low') {
//             p.priorityCriticality = 3;
//         } else {
//             p.priorityCriticality = 0; // Default/None
//         }
